...
**Tests**: Include test tasks for every user story and for every new/changed Tauri
command contract. Tests are REQUIRED unless the feature spec explicitly documents an
approved exception.
